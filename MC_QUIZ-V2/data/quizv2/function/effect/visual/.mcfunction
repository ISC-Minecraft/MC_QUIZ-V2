...
#ボスバーの名前を変更
bossbar set quiz:timer name [{color:"light_purple",score:{name:"$remain",objective:questions}},{color:"light_purple",text:"/"},{color:"light_purple",score:{name:"$max",objective:questions}},{text:" | ",color:white,bold:false},{color:white,storage:"quiz:",nbt:question.text}]
#選択中の回答を表示
