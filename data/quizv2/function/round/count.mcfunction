...
#効果音
execute if score $round countdown matches 5 as @a run function quizv2:effect/sound/round/count/
execute if score $round countdown matches 1..3 as @a run function quizv2:effect/sound/round/count/
#1秒ごとに繰り返し
