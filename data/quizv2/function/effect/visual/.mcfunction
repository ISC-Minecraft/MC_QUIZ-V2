...
execute if score $round countdown matches 1.. as @a at @s unless predicate quizv2:on_red unless predicate quizv2:on_blue unless predicate quizv2:on_green unless predicate quizv2:on_yellow run title @s actionbar ""
